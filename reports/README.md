...
| `gercek_onnx_celery_sure_tek_okuma.csv` | Görüntü kare başına bir kez okunduktan sonra aynı 157 kareyle tekrarlanan gerçek Celery süre ölçümü | `scripts/19_gercek_onnx_celery_sure.py --gorev-adi olcum-onnx-tek-okuma-… --kare-cikti reports/gercek_onnx_celery_sure_tek_okuma.csv` | Evet — taban koşuyla aynı 157 görüntü, aynı protokol ve aynı model SHA-256 |
